      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Sell your products here for huge range </br> of customers</p>
            <div>
              <a href="Supplier/signup/login.php" style="background: transparent;" class="buttondesign">Switch to Selling</a>
            </div>
          </div>
