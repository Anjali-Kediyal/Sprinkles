            ...
            <table class="tbl-50">
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Product" class="buttondesign">
                    </td>
                </tr>
            </table>
        </form>
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                if($res3==true)
                {
                    ...
                    ?>
                    <script>
                    window.location.href='http://localhost/main/Supplier/manage-food.php';
                    </script>
                    <?php
                }
                else
